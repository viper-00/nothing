...
func SendSlackMessage(subject, content, slackChannel string, resolved bool, ts string) (string, error) {
	err := godotenv.Load()
	if err != nil {
...
func buildMessage(template, subject, content, channel, color, ts string) string {
